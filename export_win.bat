...
copy ".\CGIncludes\UnityGlobalIllumination Plus.cginc" ".\export\CGIncludes\UnityGlobalIllumination Plus.cginc"
copy ".\CGIncludes\UnityImageBasedLighting Plus.cginc" ".\export\CGIncludes\UnityImageBasedLighting Plus.cginc"
copy ".\CGIncludes\UnityLightingCommon Plus.cginc" ".\export\CGIncludes\UnityLightingCommon Plus.cginc"
copy ".\CGIncludes\UnityPBSLighting Plus.cginc" ".\export\CGIncludes\UnityPBSLighting Plus.cginc"
copy ".\CGIncludes\UnityStandardBRDF Plus.cginc" ".\export\CGIncludes\UnityStandardBRDF Plus.cginc"
...
copy ".\CGIncludes\UnityStandardInput Plus.cginc" ".\export\CGIncludes\UnityStandardInput Plus.cginc"
