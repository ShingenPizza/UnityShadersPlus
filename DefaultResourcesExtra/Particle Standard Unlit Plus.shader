...
// Unity's Particle Standard Unlit shader edited by ShingenPizza. More info in README.txt .

Shader "ShingenPizza/Particle Standard Unlit Plus"
{
    Properties
    {
    ...
    Category
    {
        SubShader
        {
            Tags { "RenderType"="Opaque" "IgnoreProjector"="True" "PreviewType"="Plane" "PerformanceChecks"="False" "VRCFallback"="Particles/Standard Unlit" }
