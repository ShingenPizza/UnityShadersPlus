...
- **Limited Visibility**<br>
  ...
  Toggles for visibility in VRChat when seen directly, in mirrors, on screenshots, and on cameras (separately the default VRChat one and Hirabiki's VRCLens).<br>
- [**VRC Light Volumes**](https://github.com/REDSIM/VRCLightVolumes)<br>
  ...
  Support for the cool new "voxel based light probes replacement" (v2.1).<br>
